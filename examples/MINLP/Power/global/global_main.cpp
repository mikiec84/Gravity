...
bool arc_id_compare(const Arc* n1, const Arc* n2) { return n1->_id < n2->_id; }
...
// for the ANU project, we neglect min-up and min-down constraints in the
// original ACUC formulation while choose to relax ramp up/down constraints and
// inter temporal constraints (in total 4 constraints).
int main(int argc, const char* argv[]) {
  ...
  if (argc >= 3) {
    ...
    fname = "../data/Power/nesta_case5_pjm.m";
    // fname = "../../data/Power/nesta_case30_ieee.m";
    // fname = "../../data/Power/nesta_case6_c.m";
    // fname = "../../data/Power/nesta_case5_pjm.m";
    // fname = "../../data/Power/nesta_case3_lmbd.m";
    // fname = "../../data/Power/nesta_case300_ieee.m";
    // fname = "../../data/Power/nesta_case1354_pegase.m";
    // fname = "../../data/Power/nesta_case14_ieee.m";
    // fname = "../../data/Power/nesta_case118_ieee.m";
    // fname = "../../data/Power/nesta_case57_ieee.m";
    Num_part = 1;
    T = 1;
  }
